  ...
  getListsFromAPI: async () => {
    try {
      ...
      if (response.status !== 200) {
        ...
        // console.log(lists);
        console.log(lists);
        lists.sort((a, b) => (a.position > b.position) ? 1 : ((b.position > a.position) ? -1 : 0));
...
},{"./card":2,"./list":3}],2:[function(require,module,exports){
...
},{"./card":2,"sortablejs":4}],4:[function(require,module,exports){
/**!
 * Sortable 1.10.2
